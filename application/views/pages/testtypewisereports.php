...
<section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header with-border">
              <b>Test Report</b> <?php include'MessageAlert.php'; ?>
                <form action="<?php echo base_url('Reports/testtypereports') ?>" method="post">
                   <div class="form-row">
    <div class="col">
 ...
 <div class="row">
                    ...
                    <label>Source Type</label>
                     <select class="form-control" style="width: 100% !important"  name="client_type" required>
                  ...
                  <select name="district_id" id="district_id" class="form-control">
                    ...
                    <select class="form-control directorate_id" onchange="GetRepStations(this.value)"  name="directorate_id"   style="width: 100%" >
                    <option  value="">-select-</option>
                    <option value="all">-Select all-</option>
...
?>
                  ...
                  <div class="col-sm-6 form-group">
                    ...
                    <select class="form-control center_station_id" onchange="GetRepSections(this.value)"  name="center_station_id"  style="width: 100%" >
                        <option  value="">-select-</option>
                        <option value="all">-Select all-</option>
                   </select>
                    </div>
                  ...
                  <select class="form-control section_id" onchange="GetRepLabs(this.value)" name="section_id"  style="width: 100%">
                  <option  value="">-select-</option>
                  <option value="all">-Select all-</option>
                  ...
                  <div class="col-sm-6 form-group">
                    <label>Labs Name</label>
                     <select class="form-control lab_id" onchange="GetRepTestNames(this.value)"  style="width: 100% !important" name="lab_id"  >
                    <option  value="">-select-</option>
                    <option value="all">-Select all-</option>
                   <!--  <option  value="">-select all-</option> -->
                  </select>
                     ...
                     <div class="col-sm-6 form-group">
                  <label for="location">Test type</label>
                   <select  name="testHelp_id" class="form-control test_id" >
                     <option value="">-Select-</option>
                     <option value="all">-Select all-</option>
                  </select>
              ...
              <br>
                ...
                <div class="col-md-6">
                        <kbd class=""><?php if(!empty($districtreports)){ echo count($districtreports); } ?><kbd> 
                    </div>
...
function GetRepTehsils(vl)
{
  ...
  // alert(district_id);
    ...
    $.ajax({
        ...
        type:"POST",
        data:{district_id:district_id},
        url:"<?= base_url('Reports/GetTehsils/'); ?>",
        success:function(data)
        {
                   // alert(data);
              $('.tehsil_id').empty(); 
              $('.tehsil_id').append('<option value="">-select-</option>');
              $('.tehsil_id').append('<option value="all">-Select all-</option>');
...
function GetRepBreeds(vl)
{
  ...
  // alert(center_station_id);
    ...
    $.ajax({
        ...
        url:"<?= base_url('Reports/GetBreeds/'); ?>",
        success:function(data)
        {
                   // alert(data);
              $('.breed_id').empty();
...
function GetRepStations(vl)
{
  var directorate_id = vl;
    ...
    $.ajax({
        ...
        url:"<?= base_url('Reports/getStations/'); ?>",
        success:function(data)
        {
                   // alert(data);
                   $('.center_station_id').empty();
                    $('.center_station_id').append('<option value="">-select-</option>');
                    $('.center_station_id').append('<option value="all">-Select all-</option>');
              $.each(data, function(key, value) {
...
function GetRepSections(vl)
{
  ...
  // alert(center_station_id);
    ...
    $.ajax({
        ...
        url:"<?= base_url('Reports/GetSections/'); ?>",
        success:function(data)
        {
                   // alert(data);
              $('.section_id').empty();
              $('.section_id').append('<option value="">-select-</option>');
              $('.section_id').append('<option value="all">-Select all-</option>');
              $.each(data, function(key, value) {
...
function GetRepLabs(vl)
{
  ...
  // alert(testid);
    ...
    $.ajax({
        ...
        url:"<?= base_url('Reports/getLabs/'); ?>",
        success:function(data)
        {
              $('.lab_id').empty();
              $('.lab_id').append('<option value="">-select-</option>');
              $('.lab_id').append('<option value="all">-Select all-</option>');
              $.each(data, function(key, value) {
...
function GetRepTestNames(vl)
{
  ...
  // alert(testid);
    ...
    $.ajax({
        ...
        type:"POST",
        data:{lab_id:lab_id},
        url:"<?= base_url('Reports/getTestNames/'); ?>",
        success:function(data)
        {
              $('.test_id').empty();
              $('.test_id').append('<option value="">-select-</option>');
              $('.test_id').append('<option value="all">-Select all-</option>');
              $.each(data, function(key, value) {
              $('.test_id').append('<option value="'+ value.test_id +'">'+value.testHelp_name+'</option>');
              });
