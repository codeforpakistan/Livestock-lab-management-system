        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header with-border">
              <b> All Cancelled Reports</b> <?php include'MessageAlert.php'; ?>
              ...
              <div class="row">
                    ...
                    <div class="col-md-6">
                    <button style="margin-left:10px; " type="button" class="btn export btn-success pull-right dropdown-toggle" data-toggle="dropdown" disabled aria-expanded="false">
          ...
          <div class="box box-primary">
             <table class="table  table-striped table-hover" id="tbl-can-rep">
              <thead>
                 <tr class="bg-success">
                  <th>tracking#</th>
                  <th>Farmer/Owner</th>
...
$(document).ready(function() {
  ...
  $("#center_id").change(function(event) {
    ...
    $.ajax({
     url: "<?php echo base_url('Reports/cancel_report_ajax'); ?>",
       type: 'POST',
...
var countclick=0;
   $("#load").click(function(event) {
     ...
     $(".export").attr('disabled', false);
       countclick++;
     if(countclick>1){
      $("#tbl-can-rep").dataTable().fnDestroy();
     }
    $(".canceldata").empty();
     var status;
     var color;
     ...
     .done(function(j) {
      ...
      $(".counttest").html("Total test Conduct "+json.length);
       ...
       $.each(json, function(index, val) {
          ...
          $(".canceldata").append(table);
       });
       $('#tbl-can-rep').DataTable({
        "paging": true,
          "lengthChange": true,
          "searching": true,
          "ordering": true,
