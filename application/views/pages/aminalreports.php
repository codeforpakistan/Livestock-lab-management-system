...
<section class="content">
        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header with-border">
              <b>Animal Type wise Reports</b> <?php include'MessageAlert.php'; ?>
                <form action="<?php echo base_url('Reports/Animalreports') ?>" method="post">
                   <div class="form-row">
    <div class="col">
 ...
 <div class="row">
                    ...
                    <label>Source Type</label>
                     <select class="form-control" id="client_type" style="width: 100% !important"  name="client_type">
...
?>
                  ...
                  <div class="col-sm-6 form-group">
                    <label>Labs Name</label>
                     <select class="form-control lab_id"  style="width: 100% !important" name="lab_id"  >
                    <option  value="">-select-</option>
                    <option value="all">-Select all-</option>
                   <!--  <option  value="">-select all-</option> -->
                  </select>
                  ...
                  <select name="cattle_id" id="cattle_id" class="form-control">
                     ...
                     <option value="all">-- Select All --</option>
                    <?php 
                      $animal = $this->API_m->getRecordWhere('cattles',['is_trash'=>0]);
                        foreach ($animal as $ani) {
                       ?>
                    <option value="<?php echo $ani->cattle_id; ?>"><?php echo $ani->cattle_name; ?></option>
                    <?php  }
                     ?>
                  </select>
                    </div>
