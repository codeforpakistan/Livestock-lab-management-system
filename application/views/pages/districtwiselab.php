...
<section class="content">
 ...
 <div class="row">
                  ...
                  <select name="district_id" class="form-control" onchange="GetRepTehsil(this.value);">
                     <option value="">-- Select districts --</option>
                     <option value="all">Select all</option>
                    <?php
$district = $this->API_m->getRecordWhere('districts', ['is_trash' => 0]);
...
?>
                 ...
                 <select class="form-control " id="test_sample_id" style="width: 100% !important" name="test_sample_id">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <kbd class=""><?php if(!empty($reports)){ echo count($reports); } else { echo '0';} ?><kbd>
                    </div>
                    <div class="col-md-6">
...
function GetRepTehsil(vl)
{
  ...
  // alert(testid);
    ...
    $.ajax({
        ...
        url:"<?= base_url('Reports/getRepTehsil/'); ?>",
