        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header with-border">
              <b> All Pending Reports</b> <?php include'MessageAlert.php'; ?>
          ...
          <div class="box box-primary">
             <table class="table  table-striped table-hover" id="tbl-pending-rep">
              <thead>
                <tr class="bg-success">
      <th>tracking#</th>
      <th>Source Type</th>
...
$(document).ready(function() {
  ...
  $("#center_id").change(function(event) {
    ...
    $.ajax({
     url: "<?php echo base_url('Reports/pending_report_ajax'); ?>",
       type: 'POST',
...
var countclick = 0;
   $("#load").click(function(event) {
     ...
     countclick++;
     if(countclick>1){
      $("#tbl-pending-rep").dataTable().fnDestroy();
     }
    $(".pendingdata").empty();
     var status;
     var color;
     ...
     .done(function(j) {
      ...
      $(".counttest").html("Total test Conduct "+json.length);
       ...
       $.each(json, function(index, val) {
          ...
          $(".pendingdata").append(table);
       });
       $('#tbl-pending-rep').DataTable({
          "paging": true,
          "lengthChange": true,
          "searching": true,
          "ordering": true,
