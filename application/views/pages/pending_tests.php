        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header with-border">
              <b>Pendancy Reports</b> <?php include'MessageAlert.php'; ?>
          ...
          <div class="box box-primary">
             <table class="table table-hover table-condenced " id="tbl-pendency">
              <thead>
                <tr class="bg-success">
                  <th>#</th>
                  <th>Test Name</th>
  ...
  <div class="modal-dialog  modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title"><?=  $rec->testHelp_name;        ?></h4>
