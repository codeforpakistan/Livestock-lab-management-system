        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header with-border">
              <b>Lab wise Report</b> <?php include 'MessageAlert.php';?>
                <form action="<?php echo base_url('Reports/lab_wise_view') ?>" method="post">
                   <div class="form-row">
    <div class="col">
...
?>
          ...
          <div class="box box-primary">
            <div class="table-responsive">
             <table class="table table-hover table-condenced " id="tbl-lab">
              <thead>
              <tr class="bg-success">
                  <th>tracking#</th>
                  <th>Source Type</th>
