        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header with-border">
              <b> All Posted Reportss</b> <?php include'MessageAlert.php'; ?>
          ...
          <div class="box box-primary">
             <table class="table  table-striped table-hover" id="tbl-posted-rep">
              <thead>
                <tr class="bg-success">
      <th>tracking#</th>
      <th>Source Type</th>
...
$(document).ready(function() {
  ...
  $("#center_id").change(function(event) {
    ...
    $.ajax({
     url: "<?php echo base_url('Reports/posted_report_ajax'); ?>",
       type: 'POST',
...
var countclick=0;
   $("#load").click(function(event) {
    ...
    $(".posteddata").empty();
      countclick++;
     if(countclick>1){
       $("#tbl-posted-rep").dataTable().fnDestroy();
     }
     ...
     .done(function(j) {
      ...
      $(".counttest").html("Total test Conduct "+json.length);
       ...
       $.each(json, function(index, val) {
          ...
          $(".posteddata").append(table);
       });
       $('#tbl-posted-rep').DataTable({
        "paging": true,
          "lengthChange": true,
          "searching": true,
          "ordering": true,
